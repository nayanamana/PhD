...
def filter_pages():
   ...
   #out_dir_ph_updated = '/mnt/extra1/projects/phishing/scripts_m2/bn_updated_src'
   out_dir_ph_updated = '/mnt/extra1/projects/phishing/scripts_m2/bn_updated_src_tranco'

   if os.path.isdir(out_dir_ph_updated): rmtree(out_dir_ph_updated)
   make_dir(out_dir_ph_updated)

   #global dest_file
   #glob_files = glob.glob("/mnt/extra1/projects/phishing/scripts_m2/webpage_sources_b/*.json")
   glob_files = glob.glob("/mnt/extra1/projects/phishing/scripts_m2/webpage_sources_b_tranco/*.json")
   for f in glob_files:
       f_name = f
